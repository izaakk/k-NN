...
# Import target "faiss_avx512" for configuration "Release"
set_property(TARGET faiss_avx512 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(faiss_avx512 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libfaiss_avx512.a"
  )

list(APPEND _cmake_import_check_targets faiss_avx512 )
list(APPEND _cmake_import_check_files_for_faiss_avx512 "${_IMPORT_PREFIX}/lib/libfaiss_avx512.a" )
