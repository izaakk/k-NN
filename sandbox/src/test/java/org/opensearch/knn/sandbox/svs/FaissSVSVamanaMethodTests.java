...
public class FaissSVSVamanaMethodTests extends OpenSearchTestCase {
    ...
    /**
     * Guards the cross-module literal contract: {@code FaissMethodResolver} cannot import the sandbox
     * {@link SVSConstants}, so it hardcodes these names as string literals. Renaming a constant here fails
     * this test, signaling the matching literals in {@code FaissMethodResolver} must be updated in lockstep.
     */
    public void testResolverLiteralContract_constantsMatchHardcodedLiterals() {
