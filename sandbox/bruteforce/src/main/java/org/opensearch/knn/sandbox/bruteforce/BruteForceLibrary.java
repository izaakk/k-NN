...
public final class BruteForceLibrary extends NativeLibrary {
    ...
    /**
     * The engine's one query-time parameter: scan only the first {@code scan_limit} vectors. The limit
     * applies per segment, a query over N segments scans up to N times the limit.
     */
    ...
    private static final class ScanMethod implements KNNMethod {
        ...
        public KNNLibraryIndexingContext getKNNLibraryIndexingContext(
            ...
            return KNNLibraryIndexingContextImpl.builder()
                .parameters(Map.of(NAME, METHOD_SCAN, METHOD_PARAMETER_SPACE_TYPE, spaceType.getValue()))
                .resolvedSpec(SandboxIndexSpecs.minimalSpec(METHOD_SCAN, knnMethodContext, knnMethodConfigContext))
