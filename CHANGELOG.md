...
### Features
* Add faiss_upstream sandbox tenant: latest upstream faiss exposing HNSWFlatPanorama (onboarded via the sandbox tutorial) [#XXX2](https://github.com/opensearch-project/k-NN/pull/XXX2)
