...
### Features
* Add Intel SVS sandbox tenant: svs_vamana graph engine in a fully isolated JNI library (onboarded via the sandbox tutorial) [#XXX3](https://github.com/opensearch-project/k-NN/pull/XXX3)
* Add sandbox infrastructure for experimental engines ([#3283](https://github.com/opensearch-project/k-NN/issues/3283)) and generic engine extension points at the KNNEngine, JNIService and Query layers [#XXXX](https://github.com/opensearch-project/k-NN/pull/XXXX)
