...
* Add Intel SVS (Scalable Vector Search) as the first sandbox tenant engine: static svs_vamana graphs with flat/sq/lvq/leanvec encoders, top-k and radial search with filtering, query-time search_window_size and search_buffer_capacity; built on the sandbox extension points with zero core changes [#XXXX](https://github.com/opensearch-project/k-NN/pull/XXXX)
