...
* Add Intel SVS (Scalable Vector Search) as the first sandbox tenant engine: svs_vamana method with LVQ/SQ compression, built on the sandbox extension points with zero core changes [#XXXX](https://github.com/opensearch-project/k-NN/pull/XXXX)
