...
public enum KNNEngine implements KNNLibrary {
    ...
    // Radial and nested-field support for the experimental engine are follow-ups (both need additions to
    // the underlying native runtime), so EXPERIMENTAL is intentionally absent from these two sets.
