...
public class NativeEngines990KnnVectorsWriter extends KnnVectorsWriter {
    ...
    /** Minimum training threshold to prevent training on tiny segments. */
    private static final int MIN_TRAINING_THRESHOLD = 1000;

    /** Sentinel for training interruption. Must NOT trigger circuit breaker. */
        ...
        if (parametersString != null) {
            try {
                ...
                Map<String, Object> params = org.opensearch.common.xcontent.XContentHelper.createParser(
                    ...
                    org.opensearch.core.xcontent.MediaTypeRegistry.JSON  // explicit JSON, not runtime default
                ).map();
