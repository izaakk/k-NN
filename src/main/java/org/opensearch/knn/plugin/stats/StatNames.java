...
public enum StatNames {
    ...
    // Deferred LeanVec Training Stats (aggregate)
    DEFERRED_TRAINING_REQUESTS(KNNCounter.DEFERRED_TRAINING_REQUESTS.getName()),
    DEFERRED_TRAINING_SUCCESS(KNNCounter.DEFERRED_TRAINING_SUCCESS.getName()),
    DEFERRED_TRAINING_ERRORS(KNNCounter.DEFERRED_TRAINING_ERRORS.getName()),
    // Deferred LeanVec Training Stats (per quality level)
    DEFERRED_TRAINING_INITIAL_REQUESTS(KNNCounter.DEFERRED_TRAINING_INITIAL_REQUESTS.getName()),
    DEFERRED_TRAINING_INITIAL_SUCCESS(KNNCounter.DEFERRED_TRAINING_INITIAL_SUCCESS.getName()),
    DEFERRED_TRAINING_INITIAL_ERRORS(KNNCounter.DEFERRED_TRAINING_INITIAL_ERRORS.getName()),
    DEFERRED_TRAINING_FINAL_REQUESTS(KNNCounter.DEFERRED_TRAINING_FINAL_REQUESTS.getName()),
    DEFERRED_TRAINING_FINAL_SUCCESS(KNNCounter.DEFERRED_TRAINING_FINAL_SUCCESS.getName()),
    DEFERRED_TRAINING_FINAL_ERRORS(KNNCounter.DEFERRED_TRAINING_FINAL_ERRORS.getName()),
    DEFERRED_TRAINING_INTERRUPTED(KNNCounter.DEFERRED_TRAINING_INTERRUPTED.getName()),
    DEFERRED_TRAINING_MODEL_RECOVERIES(KNNCounter.DEFERRED_TRAINING_MODEL_RECOVERIES.getName());
